...
class Flurorouter {
  ...
  static String productoRoute = '/dashboard/productos/:id/:category';
  ...
  static void configureRoutes() {
    ...
    router.define(productoRoute, handler: DashboardHandlers.producto, transitionType: TransitionType.fadeIn);
